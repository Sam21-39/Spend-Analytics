  ...
  static ThemeData _build(ColorScheme scheme, Brightness brightness) {
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: TextStyle(color: scheme.onSurfaceVariant.withValues(alpha: 0.72)),
        prefixStyle: TextStyle(color: scheme.onSurfaceVariant),
        suffixStyle: TextStyle(color: scheme.onSurfaceVariant),
        prefixIconColor: scheme.onSurfaceVariant,
        suffixIconColor: scheme.onSurfaceVariant,
        errorStyle: TextStyle(color: scheme.error, fontSize: 12, fontWeight: FontWeight.w500),
      ...
      dropdownMenuTheme: DropdownMenuThemeData(
        ...
        menuStyle: MenuStyle(
          backgroundColor: WidgetStatePropertyAll(
            isDark ? SADark.surfaceContainerHigh : SALight.surface,
          ),
          shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: SARadius.md)),
        ),
      ),
