...
class BudgetDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color =
        args['color'] as Color? ?? Theme.of(context).colorScheme.primary;
      ...
      actions: <Widget>[
        BarActionButton(
          ...
          onTap:
              () => Get.snackbar(
                'Edit budget',
                'Budget editing from detail view is coming soon.',
              ),
        ),
        ...
        BarActionButton(
          ...
          onTap:
              () => Get.snackbar(
                'More options',
                'Additional budget actions are coming soon.',
              ),
        ),
      ],
      child: Column(
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(text: ' · ${formatInr(limit - used)} left'),
                    ],
                  ),
                ),
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: List<Widget>.generate(_dailyData.length, (i) {
