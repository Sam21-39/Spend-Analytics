...
mixin _$CategoryEntity {
 ...
 String get id; String get userId; String get name; String get type; int get sortOrder; DateTime get createdAt; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,userId,name,type,sortOrder,createdAt,updatedAt);

@override
String toString() {
  return 'CategoryEntity(id: $id, userId: $userId, name: $name, type: $type, sortOrder: $sortOrder, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String userId, String name, String type, int sortOrder, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? type = null,Object? sortOrder = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  String type,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.type,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  String type,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
return $default(_that.id,_that.userId,_that.name,_that.type,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String name,  String type,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.type,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _CategoryEntity implements CategoryEntity {
  const _CategoryEntity({required this.id, required this.userId, required this.name, required this.type, required this.sortOrder, required this.createdAt, required this.updatedAt});
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? type = null,Object? sortOrder = null,Object? createdAt = null,Object? updatedAt = null,}) {
